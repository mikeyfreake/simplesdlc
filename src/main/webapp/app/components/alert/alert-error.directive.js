(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('simplesdlcApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-simplesdlcApp-error');
                var entityKey = httpResponse.headers('X-simplesdlcApp-params');
                if (errorHeader) {
