...
class StoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Story entity")
        ...
        .repeat(2) {
            ...
            .post("/api/stories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "shortDescription":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "acceptanceCriteria":"SAMPLE_TEXT", "classification":null, "effortPoints":"0", "state":null, "urgency":null, "priority":null}""")).asJSON
            .check(status.is(201))
